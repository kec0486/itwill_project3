	...
	<div id="container">
        <section class="musical_con1">
            <div class="content1_wrap">
		    	<c:forEach var="detail" items="${exhibiList }" begin="0" end="5">
	                <dl>
	                    <dt>
            ...
            <div class="content2_wrap">
                ...
                <div class="con2_center">
                    ...
                    <dl class="hot_mus">
                    	...
                    	<c:forEach var="detail" items="${exhibiList }" begin="0" end="6">
	                        <dd><a href="getDetail?gd_num=${detail.gd_num }">${detail.gd_title }</a></dd>
	                        <!-- <dd><a href="#">데스노트</a></dd>
	                        <dd><a href="#">킹키부츠</a></dd>
	                        <dd><a href="#">킹아더</a></dd>
	                        <dd><a href="#" class="emp">블루맨그룹</a></dd>
	                        <dd><a href="#">마타하리</a></dd>
	                        <dd><a href="#">웃는 남자</a></dd> -->
