...
public class NaverLogin {
    ...
    private final static String CLIENT_ID = "DljJL9Wywjt39IgqbS6H";
    private final static String CLIENT_SECRET = "sqzQKTVHcQ";
    private final static String REDIRECT_URI = "http://localhost:8090/app/logincallback";
