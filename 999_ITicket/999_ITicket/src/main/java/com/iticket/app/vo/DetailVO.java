...
//--------------------------------
	...
	public String toString() {
		return "DetailVO [gd_num=" + gd_num + ", gd_actor=" + gd_actor + ", gd_startTime=" + gd_startTime
				...
				+ ", uploadFile=" + uploadFile + ", getGd_num()=" + getGd_num() + ", getGd_actor()=" + getGd_actor()
				+ ", getGd_startTime()=" + getGd_startTime() + ", getGd_endTime()=" + getGd_endTime()
				+ ", getGd_title()=" + getGd_title() + ", getGd_location()=" + getGd_location() + ", getGd_age()="
				+ getGd_age() + ", getGd_term()=" + getGd_term() + ", getGd_plan()=" + getGd_plan()
				+ ", getGd_runningtime()=" + getGd_runningtime() + ", getGd_servicenumber()=" + getGd_servicenumber()
				+ ", getGd_average()=" + getGd_average() + ", getGd_price()=" + getGd_price() + ", getHl_buildingnum()="
				+ getHl_buildingnum() + ", getGr_num()=" + getGr_num() + ", getSearchKeyword()=" + getSearchKeyword()
				+ ", getDeletesearchKeyword()=" + getDeletesearchKeyword() + ", getPoster()=" + getPoster()
				+ ", getImg1()=" + getImg1() + ", getImg2()=" + getImg2() + ", getUploadFile()=" + getUploadFile()
